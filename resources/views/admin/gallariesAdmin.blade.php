...
<head>
    ...
    <title>SLS | Admin | Gallaries</title>
    ...
    <section class="hero">
        <div class="register">
            ...
            <div class="register-container">
                ...
                <h2 style="text-align: center; color: var(--primary-dark); margin-bottom: 1.5rem;">Upload Match Image</h2>



                <form class="register-form" action="/gallariesAdmin" method="POST" enctype="multipart/form-data">
                @csrf

                    <div class="form-row">
                        <div class="form-group">
                            <label for="match_id">Name</label>
                    ...
                    <button type="submit" class="submit-btn">Uploade Image</button>

                    <div class="auth-buttons">
                        <a href="" class="btn btn-register" style="text-align:center">edit Team</a>
                    </div>
