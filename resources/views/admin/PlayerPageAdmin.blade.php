...
<head>
    ...
    <title>SLS | Admin | PlayerPage</title>
    ...
    <section class="hero">
        <div class="register">
            ...
            <div class="register-container">
                ...
                <h2 style="text-align: center; color: var(--primary-dark); margin-bottom: 1.5rem;">Player Registration</h2>



                <form class="register-form" action="/playerPageAdmin" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="dob" name="dob" placeholder="Enter player dob" required>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="file" id="countryimage"  name="countryimage" accept="image/*" >
                        </div>
                    ...
                    <button type="submit" class="submit-btn">Register Player</button>

                    <div class="auth-buttons">
                        <a href="" class="btn btn-register" style="text-align:center">edit Player</a>
                    </div>
