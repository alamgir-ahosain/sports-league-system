...
<head>
    ...
    <title>SLS | Admin | TeamPage</title>
    ...
    <section class="hero">
        <div class="register">
            ...
            <div class="register-container">
                ...
                <h2 style="text-align: center; color: var(--primary-dark); margin-bottom: 1.5rem;">Team Registration</h2>



                <form class="register-form" action="/teamPageAdmin" method="POST" enctype="multipart/form-data">
                @csrf

                    <div class="form-row">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="name" id="name" name="name" placeholder="Enter Team name" required>
