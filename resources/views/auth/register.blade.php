        ...
        <div class="nav-container">
            <ul class="nav-links">
               ...
               <li><a href="{{route(name: 'teamIndex')}}">TEAMS</a> </li>
                ...
                <li><a href="#galaries">GALLARIES </a></li>
            ...
            <div class="login-container">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        <!-- <form action="/register" method="POST" class="login-form" enctype="multipart/form-data"> -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Enter your confirm password" required autocomplete="new-password"> -->
