...
<li><a href="https://www.linkedin.com/in/alamgir-ahosain/" target="_blank">ABOUT</a></li>
    ...
    <div class="match-card">
        <a href="{{ route('gallariesShow', ['id' => $match->id]) }}" class="match-link">
            ...
            <div class="teams">
                <div class="team home-team">
                    <img src="images/{{$match->home_logo}}" alt="{{ $match->home_team }} Logo" class="team-logo">
                ...
                <div class="team away-team">
                    <img src="images/{{$match->away_logo}}" alt="{{ $match->away_team }} Logo" class="team-logo">
