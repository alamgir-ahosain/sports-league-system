                    ...
                    <tr>
                        ...
                        <td>
                            <div class="player-info">
                                <img src="{{ asset('images/' . $team->logo) }}" alt="Player Image">
                                <span>{{ $team->name }}</span>
                            </div>
                        </td>
                        <td>{{ $team->played }}</td>
                        ...
                        <!-- <td>{{ $team->form }}</td> -->
                        <td>
                            @foreach (str_split($team->form) as $char)
                            @if ($char === 'W')
                            <span style="color: green; font-weight: bold;">{{ $char }}</span>
                            @elseif ($char === 'D')
                            <span style="color: orange; font-weight: bold;">{{ $char }}</span>
                            @elseif ($char === 'L')
                            <span style="color: red; font-weight: bold;">{{ $char }}</span>
                            @else
                            <span>{{ $char }}</span> <!-- For any unexpected characters -->
                            @endif
                            @endforeach
                        </td>
