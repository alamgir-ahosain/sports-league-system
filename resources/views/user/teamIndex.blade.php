...
<li><a href="https://www.linkedin.com/in/alamgir-ahosain/" target="_blank">ABOUT</a></li>
    ...
    <section class="teams-section">
        <h2>Our League Teams</h2>
        <div class="team-showcase-container">
    <div class="team-showcase" id="teamShowcase">
        @foreach ($teams as $team)
            <div class="team-card">
                <div class="team-logo-wrapper">
                    <img src="{{ asset(path: 'images/'.$team->logo) }}" alt="{{ $team->name }} Logo" class="team-logo">
                </div>
                <div class="team-name">{{ $team->name }}</div>
                <!-- <a href="{{ $team->link }}" target="_blank" class="team-link">Visit Team</a> -->
                <a href="{{ route('teamDetails', ['id' => $team->id]) }}" class="team-link" >Visit Team</a>
  ...
  <!-- <script>
        const teams = [          
            ...
            { name: "barcelona", logo: "images/barca.png",link: "https://www.juventus.com" },
            { name: "real madrid", logo: "images/real.png" ,link: "https://www.juventus.com"},
            { name: "juventus", logo: "images/juventus.png",link: "https://www.juventus.com" }, 
            { name: "liverpool", logo: "images/Liverpool.png",link: "https://www.juventus.com" }, 
