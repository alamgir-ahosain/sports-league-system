...
<li><a href="https://www.linkedin.com/in/alamgir-ahosain/" target="_blank">ABOUT</a></li>
    ...
    <!-- <h1 style="text-align: center; margin-top: 110px;">{{$teaminfos->name}}</h1> -->
    <div class="gallery">
    
            <img class="gallery-image" src="{{ asset('images/' . $teaminfos->logo) }}" alt="Gallery Image">
   ...
   <div class="cards-container">
        @foreach($playerinfos as $player)
            <div class="card">
                 ...
                 <a href="{{route('player',['id'=>$player->id]) }}" class='player-link'>

                <div style="position: relative;">
                    @if($player->profileimage)
                        <img src="{{ asset('images/' . $player->profileimage) }}" 
                             alt="{{ $player->name }}" 
                             class="player-image">
                    @else
                        <img src="{{ asset('images/default-player.jpg') }}" 
                ...
                <div>
                <p class="player-name" style="text-align:center">{{ $player->position ?? 0 }}</p>
                ...
                <div class="stats-container">
                    ...
                    <!-- <div class="stat-item">
                        <p class="stat-value">{{ $player->saves ?? 0 }}</p>
                        <p class="stat-label">Saves</p>
                    </div> -->
                    <div class="stat-item">
                        <p class="stat-value">{{ $player->id ?? 0 }}</p>
                        <p class="stat-label">Joursy<br>Number</p>
                    </div>
                    <!-- <div class="stat-divider"></div> -->

                    <div class="stat-item">
                        <p class="stat-value">{{ $player->played ?? 0 }}</p>
                        <p class="stat-label">Matches<br>Played</p>
                    </div>
                </div>
                ...
                <div class="player-name">
                    ...
                    @endphp
                    <h1 class="first-name">{{ $firstName }} {{ $lastName }}</h1>
                </div>
                </a>
            </div>
        @endforeach
