...
<li><a href="https://www.linkedin.com/in/alamgir-ahosain/" target="_blank">ABOUT</a></li>
    ...
    <div class="match">
        <a href="{{ route('matches.show', ['id' => $match->id]) }}" class="match-link" >
            <div class="date">
                {{ \Carbon\Carbon::parse($match->date)->format('F d, Y') }} | Matchday: {{ $match->id }}
            </div>
            <div class="teams">
                <div class="team">
                    <img src="images/{{$match->home_logo}}" alt="{{ $match->home_team }} Logo">
                ...
                <div class="team">
                    <img src="images/{{$match->away_logo}}" alt="{{ $match->away_team }} Logo">
